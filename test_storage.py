...
def linear_forward(A, W, b): 
    ...
    # A with shape (784, 60000) & W with shape (60, 784) will give Z with shape (60,60000)
...
# def custom_test():
#     image_path = input("enter image path- use \\ :")
...
#     print(img_array);
#     array = img_array.reshape(784,1)
#     A_out,caches = L_model_forward(array,parameters)
#     Output = np.argmax(A_out)
#     print('guess',Output,', actual',label)
...
def custom_test():
    # image_path = input("Enter image path (use \\\\): ")
    # label = int(input("What's the number: "))
    ...
    # image_to_csv("D:/Python Directory/Mnist_data/digit_test_images/7_1.jpg","D:/Python Directory/Mnist_data/digit_test_csv/img7_1.csv")
    img_array = get_from_csv("D:/Python Directory/Mnist_data/digit_test_csv/img7_1.csv")
    
    # Forward propagate through the network
    A_out, caches = L_model_forward(img_array, parameters)
    
    # Get the predicted label
    output_label = np.argmax(A_out)
    
    # print('Guess:', output_label, ', Actual:', label)
    print('Guess:', output_label)
